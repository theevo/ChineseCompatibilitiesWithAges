...
final class AgeCalculatorTests: XCTestCase {
    func test_birthday_10_31_1947_isAge76() throws {
        let sut = try AgeCalculator(birthday: "10-31-1947", on: date("12-22-2023"))
    ...
    func test_1dayOld_isAgeZero() throws {
        let sut = try AgeCalculator(birthday: "01-02-2023", on: date("01-01-2023"))
        XCTAssertEqual(sut.age, 0)
    }
    
    func test_364daysOld_isAgeZero() throws {
        let sut = try AgeCalculator(birthday: "01-01-2022", on: date("12-31-2022"))
        XCTAssertEqual(sut.age, 0)
    }
    
    func test_dates1YearApart_isAgeOne() throws {
        let sut = try AgeCalculator(birthday: "01-01-2022", on: date("01-01-2023"))
        XCTAssertEqual(sut.age, 1)
    }
    
    func test_birthday_01_01_2023_whenTodayIsYear2000_isNegative23() throws {
        let sut = try AgeCalculator(birthday: "01-01-2023", on: date("01-01-2000"))
        XCTAssertEqual(sut.age, -23)
    }
    
    func test_birthday_11_26_1978_on_11_26_2023_isAge45() throws {
        let sut = try AgeCalculator(birthday: "11-26-1978", on: date("11-26-2023"))
        XCTAssertEqual(sut.age, 45)
    }
    
    func test_birthday_11_26_1978_on_11_26_2024_isAge46() throws {
        let sut = try AgeCalculator(birthday: "11-26-1978", on: date("11-26-2024"))
        XCTAssertEqual(sut.age, 46)
    }
    
    func test_birthday_11_26_1978_on_11_25_2023_isAge44() throws {
        let sut = try AgeCalculator(birthday: "11-26-1978", on: date("11-25-2023"))
        XCTAssertEqual(sut.age, 44)
    }
    
    func test_birthday_01_23_1974_on_01_22_2024_isAge49() throws {
        let sut = try AgeCalculator(birthday: "01-23-1974", on: date("01-22-2024"))
        XCTAssertEqual(sut.age, 49)
    }
    
    func test_birthday_01_23_1974_on_01_23_2023_isAge49() throws {
        let sut = try AgeCalculator(birthday: "01-23-1974", on: date("01-23-2023"))
        XCTAssertEqual(sut.age, 49)
    }
    
    func test_birthday_01_23_1974_on_01_24_2024_isAge50() throws {
        let sut = try AgeCalculator(birthday: "01-23-1974", on: date("01-24-2024"))
        print(sut)
